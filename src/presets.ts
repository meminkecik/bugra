...
export const M8_TEST_PRESETS: Preset[] = [
  // --- GRUP 1: KESKİN & BOZDOĞAN (2024) REFERANS DEĞERLİ İSTASYONLAR ---
  {
    ...
    description: "Keskin & Bozdogan (2024) Table 13. Exact T=0.3254s -> Vsa ~430 m/s",
    defaultRho: 1800,
    layers: [
      ...
      { id: "8", d: 7.10, vs: 493, vp: 1544, rho: 2000 },
  ...
  },
  {
    ...
    description: "Keskin & Bozdogan (2024) Table 13. Exact T=0.1772s -> Vsa ~814 m/s",
    defaultRho: 2100,
    layers: [
      ...
      { id: "6", d: 7.30, vs: 835, vp: 1976, rho: 2200 },
  ...
  // Not: Exact değeri = (4 * Toplam Derinlik) / (Rapordaki Hakim Periyot) formülüyle Vsa'ya çevrilmiştir.
  {
    ...
    layers: [
      ...
      { id: "5", d: 2.30, vs: 799, vp: 2821, rho: 2200 },
  ...
  },
  {
    ...
    layers: [
      ...
      { id: "9", d: 6.30, vs: 531, vp: 877, rho: 2000 },
  ...
  },
  {
    ...
    layers: [
      ...
      { id: "2", d: 7.00, vs: 533, vp: 1184, rho: 2000 },
  ...
  },
  {
    ...
    layers: [
      ...
      { id: "7", d: 5.90, vs: 515, vp: 1044, rho: 2000 },
      { id: "8", d: 6.70, vs: 551, vp: 1044, rho: 2000 }
    ],
  ...
  },
  {
    ...
    layers: [
      ...
      { id: "6", d: 0.80, vs: 603, vp: 1508, rho: 2000 }
    ],
  ...
  },
  {
    ...
    layers: [
      ...
      { id: "4", d: 2.40, vs: 268, vp: 1271, rho: 1960 },
      { id: "5", d: 3.00, vs: 261, vp: 1295, rho: 1970 },
...
export const PRESETS: Preset[] = [...M8_TEST_PRESETS, ...PAPER_PRESETS, ...LOCAL_PRESETS];
